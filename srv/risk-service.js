...
module.exports = cds.service.impl(async function() {
    ...
    this.after("READ", Risks, (data) => {
        ...
        // Loop through the array of risks to set the virtual field 'criticality'
        risks.forEach((risk) => {
            // Set criticality based on impact
...
this.on("READ", Risks, async (req, next) => {
    /* Check whether the request wants an "expand" of the business partner.
       ...
       are in different systems: SAP BTP and S/4 HANA Cloud), remove it if present. */
    ...
    if (expandIndex < 0) return next(); // No expand found
